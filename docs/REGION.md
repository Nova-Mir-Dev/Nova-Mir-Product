...
Your application is configured for the `us-east-1` region.
...
- Data stored in us-east-1 is subject to regional data protection laws
- Verify this region meets your compliance requirements
