...
This document summarizes applicable regulations and compliance requirements for nova-mir-product.
...
- User tracking level: **minimal** — Anonymous page views only — no cookies or PII collected.
- Data retention: **90 days**
- Analytics provider: **plausible**
- Markets: ca, us, eu, uk, mx, au
