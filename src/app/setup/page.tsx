    ...
    >
      <Stack spacing="lg">
        <Text element={{ as: 'h1', size: 'h1' }} weight="bold">
          "nova-mir-product" — Setup
        </Text>
        <Text color="secondary">
          Complete the steps below to get your application running. Each service
          links to where you need to create an account and get your API keys.
        </Text>
